  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // max-w-lg: формы в два столбца (сумма+дата, счёт+статья) в 384px не
          // помещались — значения налезали друг на друга. Высокие формы
          // (товар, поставка) скроллятся внутри окна, а не уезжают за экран.
